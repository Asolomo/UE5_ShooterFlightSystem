...
#include "NotAnthem/CharacterBase.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeCharacterBase() {}

// Begin Cross Module References
ENGINE_API UClass* Z_Construct_UClass_ACharacter();
NOTANTHEM_API UClass* Z_Construct_UClass_ACharacterBase();
NOTANTHEM_API UClass* Z_Construct_UClass_ACharacterBase_NoRegister();
UPackage* Z_Construct_UPackage__Script_NotAnthem();
...
UObject* (*const Z_Construct_UClass_ACharacterBase_Statics::DependentSingletons[])() = {
	...
	(UObject* (*)())Z_Construct_UPackage__Script_NotAnthem,
};
...
template<> NOTANTHEM_API UClass* StaticClass<ACharacterBase>()
{
	return ACharacterBase::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_NotAnthem_Source_NotAnthem_CharacterBase_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ACharacterBase, ACharacterBase::StaticClass, TEXT("ACharacterBase"), &Z_Registration_Info_UClass_ACharacterBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACharacterBase), 3988555439U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_NotAnthem_Source_NotAnthem_CharacterBase_h_3134448008(TEXT("/Script/NotAnthem"),
	Z_CompiledInDeferFile_FID_NotAnthem_Source_NotAnthem_CharacterBase_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_NotAnthem_Source_NotAnthem_CharacterBase_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
